...
<html lang="en">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <input type="hidden" name="iduserdihapus" value="<?=$iduser;?>">
                                        ...
                                        <div class="modal fade" id="edit<?=$iduser;?>">
                                            <div class="modal-dialog">
                                                ...
                                                <input type="text" name="uid" value="<?=$uid;?>" class="form-control" required>
                                                <br>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            ...
            <br>
            <div id="norfid">
            <!-- <input type="text" name="uid" id="norfid" class="form-control" required> -->
            </div>
            <br>
