...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Management Admin</h1>
                        <div class="card mb-4">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=$password;?></td>
                                            <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?=$idadmin;?>">
                                                Edit
                                            </button>
                                            <input type="hidden" name="idadmindihapus" value="<?=$idadmin;?>">
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idadmin;?>">
                                                Delete
                                            </button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="edit<?=$idadmin;?>">
                                            <div class="modal-dialog">
                                                ...
                                                <br>
                                                <input type="text" name="nomorhp" value="<?=$nomorhp;?>" class="form-control" required>
                                                <br>
                                        ...
                                        <div class="modal fade" id="delete<?=$idadmin;?>">
                                            <div class="modal-dialog">
                                                ...
                                                <br><br>
                                                <input type="hidden" name="idadmin" value="<?=$idadmin?>">
                                                <button type="submit" class="btn btn-primary" name="hapusadmin">Submit</button>
                                                <br>
                                                </div>
                                                </form>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            ...
            <br>
            <input type="text" name="nomorhp" placeholder="Nomor Hp" class="form-control" required>
            <br>
